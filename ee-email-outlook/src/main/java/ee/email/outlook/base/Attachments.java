...
/**
 * @see <p>
 *      Type <a href="http://msdn.microsoft.com/en-us/library/aa210901(v=office.11).aspx">Attachments</a>
 *      </p>
 *      <p>
...
public class Attachments<E extends Attachment> extends OleCollection<E> {

  public Attachments(OleAutomation auto, boolean initImmediate) {
    ...
    super(auto, initImmediate, new OleAutoFactory<E>() {
      ...
      public E createOleAutoObject(OleAutomation auto, boolean initImmediate) {
        ...
        return (E) new Attachment(auto, initImmediate);
      }
    });

  }

  public Attachments(OleAutomation auto, boolean initImmediate, OleAutoFactory<E> childFactory) {
