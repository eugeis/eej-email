...
/**
 * @see <p>
 *      Type <a href="http://msdn.microsoft.com/en-us/library/aa210886(v=office.11).aspx">Actions</a>
 *      </p>
 *      <p>
...
public class Actions<E extends Action> extends OleCollection<E> {

  public Actions(OleAutomation auto, boolean initImmediate) {
    ...
    super(auto, initImmediate, new OleAutoFactory<E>() {
      ...
      public E createOleAutoObject(OleAutomation auto, boolean initImmediate) {
        ...
        return (E) new Action(auto, initImmediate);
      }
    });

  }

  public Actions(OleAutomation auto, boolean initImmediate, OleAutoFactory<E> childFactory) {
