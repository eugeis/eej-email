...
/**
 * @see <p>
 *      Type <a href="http://msdn.microsoft.com/en-us/library/aa210909(v=office.11).aspx">DistListItem</a>
 *      </p>
 *      <p>
 ...
 *      href="http://msdn.microsoft.com/en-us/library/aa211840(v=office.11).aspx">DLName</a> | <a
 ...
 *      href="http://msdn.microsoft.com/en-us/library/aa171488(v=office.11).aspx">MemberCount</a> | <a
 ...
 *      </p>
 *      <p>
 *      Methods | <a href="http://msdn.microsoft.com/en-us/library/aa219407(v=office.11).aspx">AddMember</a> | <a
 *      href="http://msdn.microsoft.com/en-us/library/aa219405(v=office.11).aspx">AddMembers</a> | <a
 ...
 *      href="http://msdn.microsoft.com/en-us/library/aa220107(v=office.11).aspx">GetMember</a> | <a
 ...
 *      href="http://msdn.microsoft.com/en-us/library/aa220136(v=office.11).aspx">RemoveMember</a> | <a
 *      href="http://msdn.microsoft.com/en-us/library/aa220134(v=office.11).aspx">RemoveMembers</a> | <a
...
public class DistListItem extends OleAuto {
  ...
  public DistListItem(OleAutomation auto, boolean initImmediate) {
  ...
  /**
   * @see <a href="http://msdn.microsoft.com/en-us/library/aa211840(v=office.11).aspx">DLName</a>
   */
  public String getDLName() {

    String propertyName = "DLName";
    try {
      if (this.dLName == null) {
        this.dLName = getStringValue(propertyName);
      }
    } catch (Exception e) {
      handleGetPropertyException(e, propertyName);
    }
  ...
  /**
   * @see <a href="http://msdn.microsoft.com/en-us/library/aa171488(v=office.11).aspx">MemberCount</a>
   */
  public Variant getMemberCount() {

    String propertyName = "MemberCount";
    try {
      if (this.memberCount == null) {
        this.memberCount = getProperty(propertyName);
      }
    } catch (Exception e) {
      handleGetPropertyException(e, propertyName);
    }
