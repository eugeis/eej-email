...
/**
 * @see <p>
 *      Type <a href="http://msdn.microsoft.com/en-us/library/aa210978(v=office.11).aspx">Pages</a>
 *      </p>
 *      <p>
...
public class Pages<E extends OleAuto> extends OleCollection<E> {

  public Pages(OleAutomation auto, boolean initImmediate) {

    super(auto, initImmediate, new DefaultOleAutoFactory());
  }

  public Pages(OleAutomation auto, boolean initImmediate, OleAutoFactory<E> childFactory) {
