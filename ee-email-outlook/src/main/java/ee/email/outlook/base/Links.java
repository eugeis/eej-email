...
/**
 * @see <p>
 *      Type <a href="http://msdn.microsoft.com/en-us/library/aa210939(v=office.11).aspx">Links</a>
 *      </p>
 *      <p>
...
public class Links<E extends Link> extends OleCollection<E> {

  public Links(OleAutomation auto, boolean initImmediate) {
    ...
    super(auto, initImmediate, new OleAutoFactory<E>() {
      ...
      public E createOleAutoObject(OleAutomation auto, boolean initImmediate) {
        ...
        return (E) new Link(auto, initImmediate);
      }
    });

  }

  public Links(OleAutomation auto, boolean initImmediate, OleAutoFactory<E> childFactory) {
