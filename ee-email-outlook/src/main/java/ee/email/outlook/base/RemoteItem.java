...
/**
 * @see <p>
 *      Type <a href="http://msdn.microsoft.com/en-us/library/aa211033(v=office.11).aspx">RemoteItem</a>
 *      </p>
 *      <p>
 ...
 *      href="http://msdn.microsoft.com/en-us/library/aa212146(v=office.11).aspx">HasAttachment</a> | <a
 ...
 *      href="http://msdn.microsoft.com/en-us/library/aa171906(v=office.11).aspx">RemoteMessageClass</a> | <a
 ...
 *      href="http://msdn.microsoft.com/en-us/library/aa220714(v=office.11).aspx">TransferSize</a> | <a
 *      href="http://msdn.microsoft.com/en-us/library/aa220718(v=office.11).aspx">TransferTime</a> | <a
...
public class RemoteItem extends OleAuto {
  ...
  protected String remoteMessageClass;
  ...
  protected Variant transferSize;

  protected Variant transferTime;

  protected Boolean unRead;

  protected UserProperties userProperties;

  public RemoteItem(OleAutomation auto, boolean initImmediate) {
  ...
  /**
   * @see <a href="http://msdn.microsoft.com/en-us/library/aa212146(v=office.11).aspx">HasAttachment</a>
   */
  public Boolean getHasAttachment() {

    String propertyName = "HasAttachment";
    try {
      if (this.hasAttachment == null) {
        this.hasAttachment = getBooleanValue(propertyName);
      }
    } catch (Exception e) {
      handleGetPropertyException(e, propertyName);
    }
  ...
  /**
   * @see <a href="http://msdn.microsoft.com/en-us/library/aa171906(v=office.11).aspx">RemoteMessageClass</a>
   */
  public String getRemoteMessageClass() {

    String propertyName = "RemoteMessageClass";
    try {
      if (this.remoteMessageClass == null) {
        this.remoteMessageClass = getStringValue(propertyName);
      }
    } catch (Exception e) {
      handleGetPropertyException(e, propertyName);
    }
    return this.remoteMessageClass;
  }
  ...
  /**
   * @see <a href="http://msdn.microsoft.com/en-us/library/aa220714(v=office.11).aspx">TransferSize</a>
   */
  public Variant getTransferSize() {

    String propertyName = "TransferSize";
    try {
      if (this.transferSize == null) {
        this.transferSize = getProperty(propertyName);
      }
    } catch (Exception e) {
      handleGetPropertyException(e, propertyName);
    }
  ...
  /**
   * @see <a href="http://msdn.microsoft.com/en-us/library/aa220718(v=office.11).aspx">TransferTime</a>
   */
  public Variant getTransferTime() {

    String propertyName = "TransferTime";
    try {
      if (this.transferTime == null) {
        this.transferTime = getProperty(propertyName);
      }
    } catch (Exception e) {
      handleGetPropertyException(e, propertyName);
    }
