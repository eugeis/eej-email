...
/**
 * @see <p>
 *      Type <a href="http://msdn.microsoft.com/en-us/library/aa210936(v=office.11).aspx">JournalItem</a>
 *      </p>
 *      <p>
 ...
 *      href="http://msdn.microsoft.com/en-us/library/aa211841(v=office.11).aspx">DocPosted</a> | <a
 *      href="http://msdn.microsoft.com/en-us/library/aa211842(v=office.11).aspx">DocPrinted</a> | <a
 *      href="http://msdn.microsoft.com/en-us/library/aa211843(v=office.11).aspx">DocRouted</a> | <a
 *      href="http://msdn.microsoft.com/en-us/library/aa211844(v=office.11).aspx">DocSaved</a> | <a
 ...
 *      href="http://msdn.microsoft.com/en-us/library/aa210306(v=office.11).aspx">StartTimer</a> | <a
 *      href="http://msdn.microsoft.com/en-us/library/aa210312(v=office.11).aspx">StopTimer</a>
 *      </p>
 *      <p>
...
public class JournalItem extends OleAuto {
  ...
  protected Boolean docPosted;

  protected Boolean docPrinted;

  protected Boolean docRouted;

  protected Boolean docSaved;
  ...
  public JournalItem(OleAutomation auto, boolean initImmediate) {
  ...
  /**
   * @see <a href="http://msdn.microsoft.com/en-us/library/aa211841(v=office.11).aspx">DocPosted</a>
   */
  public Boolean getDocPosted() {

    String propertyName = "DocPosted";
    try {
      if (this.docPosted == null) {
        this.docPosted = getBooleanValue(propertyName);
      }
    } catch (Exception e) {
      handleGetPropertyException(e, propertyName);
    }
    return this.docPosted;
  }

  /**
   * @see <a href="http://msdn.microsoft.com/en-us/library/aa211842(v=office.11).aspx">DocPrinted</a>
   */
  public Boolean getDocPrinted() {

    String propertyName = "DocPrinted";
    try {
      if (this.docPrinted == null) {
        this.docPrinted = getBooleanValue(propertyName);
      }
    } catch (Exception e) {
      handleGetPropertyException(e, propertyName);
    }
  ...
  /**
   * @see <a href="http://msdn.microsoft.com/en-us/library/aa211843(v=office.11).aspx">DocRouted</a>
   */
  public Boolean getDocRouted() {

    String propertyName = "DocRouted";
    try {
      if (this.docRouted == null) {
        this.docRouted = getBooleanValue(propertyName);
      }
    } catch (Exception e) {
      handleGetPropertyException(e, propertyName);
    }
    return this.docRouted;
  }

  /**
   * @see <a href="http://msdn.microsoft.com/en-us/library/aa211844(v=office.11).aspx">DocSaved</a>
   */
  public Boolean getDocSaved() {

    String propertyName = "DocSaved";
    try {
      if (this.docSaved == null) {
        this.docSaved = getBooleanValue(propertyName);
      }
    } catch (Exception e) {
      handleGetPropertyException(e, propertyName);
    }
    return this.docSaved;
  }
