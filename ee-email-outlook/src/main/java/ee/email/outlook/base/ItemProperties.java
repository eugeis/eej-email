...
/**
 * @see <p>
 *      Type <a href="http://msdn.microsoft.com/en-us/library/aa210924(v=office.11).aspx">ItemProperties</a>
 *      </p>
 *      <p>
 ...
 *      href="http://msdn.microsoft.com/en-us/library/aa210913(v=office.11).aspx">Exception</a> | <a
 ...
 *      href="http://msdn.microsoft.com/en-us/library/aa210956(v=office.11).aspx">NoteItem</a> | <a
...
public class ItemProperties<E extends ItemProperty> extends OleCollection<E> {

  public ItemProperties(OleAutomation auto, boolean initImmediate) {
    ...
    super(auto, initImmediate, new OleAutoFactory<E>() {
      ...
      public E createOleAutoObject(OleAutomation auto, boolean initImmediate) {
        ...
        return (E) new ItemProperty(auto, initImmediate);
      }
    });

  }

  public ItemProperties(OleAutomation auto, boolean initImmediate, OleAutoFactory<E> childFactory) {
