...
/**
 * @see <p>
 *      Type <a href="http://msdn.microsoft.com/en-us/library/aa210890(v=office.11).aspx">AddressEntries</a>
 *      </p>
 *      <p>
 ...
 *      <a href="http://msdn.microsoft.com/en-us/library/aa210895(v=office.11).aspx">AddressList</a>
 *      </p>*
 * @author eugeis
 */

public class AddressEntries<E extends AddressEntry> extends OleCollection<E> {

  public AddressEntries(OleAutomation auto, boolean initImmediate) {
    ...
    super(auto, initImmediate, new OleAutoFactory<E>() {
      ...
      public E createOleAutoObject(OleAutomation auto, boolean initImmediate) {
        ...
        return (E) new AddressEntry(auto, initImmediate);
      }
    });

  }

  public AddressEntries(OleAutomation auto, boolean initImmediate, OleAutoFactory<E> childFactory) {
