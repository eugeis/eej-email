...
/**
 * @see <p>
 *      Type <a href="http://msdn.microsoft.com/en-us/library/aa211206(v=office.11).aspx">Views</a>
 *      </p>
 *      <p>
 ...
 *      </p>
 *      <p>
 *      Events | <a href="http://msdn.microsoft.com/en-us/library/aa219366(v=office.11).aspx">ViewAdd</a> | <a
 *      href="http://msdn.microsoft.com/en-us/library/aa219367(v=office.11).aspx">ViewRemove</a>
 *      </p>*
 * @author eugeis
 */

public class Views<E extends View> extends OleCollection<E> {

  public Views(OleAutomation auto, boolean initImmediate) {
    ...
    super(auto, initImmediate, new OleAutoFactory<E>() {
      ...
      public E createOleAutoObject(OleAutomation auto, boolean initImmediate) {
        ...
        return (E) new View(auto, initImmediate);
      }
    });

  }

  public Views(OleAutomation auto, boolean initImmediate, OleAutoFactory<E> childFactory) {
