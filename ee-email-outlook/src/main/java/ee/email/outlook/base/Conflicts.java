...
/**
 * @see <p>
 *      Type <a href="http://msdn.microsoft.com/en-us/library/aa210904(v=office.11).aspx">Conflicts</a>
 *      </p>
 *      <p>
...
public class Conflicts<E extends Conflict> extends OleCollection<E> {

  public Conflicts(OleAutomation auto, boolean initImmediate) {
    ...
    super(auto, initImmediate, new OleAutoFactory<E>() {
      ...
      public E createOleAutoObject(OleAutomation auto, boolean initImmediate) {
        ...
        return (E) new Conflict(auto, initImmediate);
      }
    });

  }

  public Conflicts(OleAutomation auto, boolean initImmediate, OleAutoFactory<E> childFactory) {
